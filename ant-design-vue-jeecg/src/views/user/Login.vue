...
<div class="loginleft">
  ...
  <img src="../../views/images/login-bg.png" style="height: 450px;width: 500px;" >
</div>
<div>
    <div ><img src="../../views/images/qrimg.png" style="height: 200px;width: 150px;" /></div>
    <div class="loginRight">

    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      <a-form-item><a href="/">

        <img src="/logo.png" class="logo" alt="logo" style="height: 20px;height: 32px">
        <span class="title"> 无锡市城市重点建设项目管理中心</span>
      </a>
      </a-form-item>
