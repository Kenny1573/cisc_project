<template>
  <a-card  :bordered="false">
    ...
    <div class="table-operator" v-if="mainId">
      <a-button v-has="'pcompany:edit'" @click="handleAdds" type="primary" icon="plus">选择</a-button>
      <a-dropdown v-has="'pcompany:delete'" v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item key="1" @click="batchDeld"><a-icon type="delete"/>删除</a-menu-item>
        </a-menu>
