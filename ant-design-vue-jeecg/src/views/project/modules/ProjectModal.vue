              ...
              <a-row>
                <a-col span="12">
                  <a-form-item label="经度" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input v-decorator="['prjLongitude', validatorRules.prjLongitude]" disabled placeholder="请点击地图获取数据"></a-input>
                  </a-form-item>
                </a-col>
                <a-col span="12">
                  <a-form-item label="纬度" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input v-decorator="['prjLatitude', validatorRules.prjLatitude]" disabled placeholder="请点击地图获取数据"></a-input>
                  </a-form-item>
                </a-col>
              </a-row>
              <a-row>
            ...
            <a-row class="form-row" span="24" type="flex" justify="space-around">
              <a-col span="12">
                <a-form-item label="前期业主代表">
                  <a-col :span="22">
                    <j-select-user-by-dep ref="leaderspreOwner" v-model="leaders.preOwner" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="实施业主代表">
                  <a-col :span="22">
                    <j-select-user-by-dep ref="leadersmidOwner"  v-model="leaders.midOwner" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="16" type="flex" justify="space-around">
              <a-col span="12">
                <a-form-item label="总工程师办公室">
                  <a-col :span="22">
                    <j-select-user-by-dep ref="leadersoffice"  v-model="leaders.office" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="计划部">
                  <a-col :span="22">
                    <j-select-user-by-dep ref="leadersplan" v-model="leaders.plan" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="16" type="flex" justify="space-around">
              <a-col span="12">
                <a-form-item label="道桥部">
                  <a-col :span="22">
                    <j-select-user-by-dep ref="leadersbridge"  v-model="leaders.bridge" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="建筑部部">
                  <a-col :span="22">
                    <j-select-user-by-dep  ref="leadersbuild" v-model="leaders.build" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="16" type="flex" justify="space-around">
              <a-col span="12">
                <a-form-item label="质安部">
                  <a-col :span="22">
                    <j-select-user-by-dep  ref="leadersquality"  v-model="leaders.quality" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="财务部">
                  <a-col :span="22">
                    <j-select-user-by-dep  ref="leadersfinance" v-model="leaders.finance" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="16" type="flex" justify="space-around">
              <a-col span="12">
                <a-form-item label="跟踪审计(外)">
                  <a-col :span="22">
                    <j-select-user-by-dep  ref="leadersother" v-model="leaders.other" :multi="true"></j-select-user-by-dep>
                  </a-col>
                </a-form-item>
              </a-col>
              <a-col span="12"></a-col>
...
<script>
  ...
  import location from '@/views/images/Location.png'
  import Vue from 'vue'
    ...
    data () {
      return {
        ...
        validatorRules: {
          ...
          prjLongitude: {
            rules: [
              { required: false, message: '请输入工程参数!' },              { pattern: /^.{0,100}$/, message:'超出最大输入长度，最大输入长度为100'},
        ...
        if(this.model.id) {
          ...
          getAction(this.url.leader, { prjlPrjId: this.model.id }).then((res) => {
            ...
            if (res.success) {
              ...
              this.leaders.prjId=this.model.id
            }
            if (res.code === 510) {
          ...
          if (!err) {
            ...
            httpAction(httpurl, formData, method).then((res) => {
              if (res.success) {
                ...
                postAction(this.url.editleaders,this.leaders).then((res) =>{

                })

                that.$message.success(res.message)
                that.$emit('setVs',this.model)
              } else {
