<template xmlns:background-color="http://www.w3.org/1999/xhtml">
  <div>
    <a-card :title="this.info.prjName" :bordered="false" :class="'cust-erp-sub-tab'" style="width: 1520px">
  <a-row :gutter="10">
    <a-col :md="8" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px;">
          <a-button v-if="showadd" v-has="'scheduleplan:opt'" @click="handleAdd(2)" type="link" >添加节点</a-button>
          <a-button @click="gantt" type="link" >甘特图</a-button>
        </a-row>
          ...
          <a-col :md="10" :sm="24">
            ...
            <a-tree
              ...
              @expand="onExpand"/>
                ...
                <!--新增右键点击事件,和增加添加和删除功能-->
                <a-menu v-has="'scheduleplan:opt'" slot="overlay">
    ...
    <a-col :md="16" :sm="24">
      <a-tabs defaultActiveKey="1">
          ...
          <a-card :bordered="false" v-if="selectedKeys.length>0&&this.show">
            <a v-has="'scheduleplan:opt'" slot="extra" @click="update">编辑</a>
...
<script>
  ...
  export default {
    ...
    components: {
      SchedulePlanModal,JUpload,JDate,JDictSelectTag,SchedulePlanGanttList
        ...
        this.$confirm({
          ...
          onOk: function () {
            getAction(that.url.delete,{id:that.rightClickSelectedKey}).then((res)=>{
              this.refresh();
              that.disabledd=this.getBool('true')
            })
