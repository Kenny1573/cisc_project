  ...
  export default {
    ...
    methods: {
      ...
      createObjOk(e) {
        ...
        console.log('----------'+`${window._CONFIG['domianURL']}${this.url.create}?name=${this.createObj.name||""}&key=${this.createObj.key||""}&description=${this.createObj.description||""}`);
      ...
      updatelc(id){
        ...
        this.$message
          ...
          .then(() => {
            ...
            console.log(`${window._CONFIG['domianURL']}${_this.url.update}${id}`)
