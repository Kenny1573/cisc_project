...
<!--      <a-select @change="yearChange"  style="width: 150px">
        <a-select-option :span="12" v-for="(year,index) in this.yearList" :key="year.id"> {{year.ypYear}}
      ...
      <div align="center" style="width: 100%" >
        <a-dropdown  style="width: 80px" v-if="this.initYear" >
          <a >{{this.initYear}}年<a-icon type="down"/></a>
          <a-menu slot="overlay">
