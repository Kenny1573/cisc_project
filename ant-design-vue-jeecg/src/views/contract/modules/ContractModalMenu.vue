  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item v-show="this.show" label="项目选择" :labelCol="labelCol" :wrapperCol="wrapperCol">
          {{this.projectName}}<a-tag color="red" style="float: right" @click="handleEd"  size="small">选择</a-tag>
        </a-form-item>
...
<script>
  ...
  export default {
    name: "ContractModalMenu",
    components: {
      JDate,
      JUpload,
      ProjectSelect,JDictSelectTag
    },
    props:{
     conPrjId:{
        type:Number,
    ...
    methods: {
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'conPrjId','conName','conNumber','conPartyA','conPartyB','conPartyC','conMoney','conSignDate','conBeginDate','conEndDate','conAttachment','conDetailList'))
      },
