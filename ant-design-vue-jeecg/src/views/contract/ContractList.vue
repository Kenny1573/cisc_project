<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('合同信息')">导出</a-button>
    ...
    <contract-modal-menu ref="modalForm" @ok="modalFormOk"></contract-modal-menu>
  </a-card>
</template>
...
<script>
  ...
  import ContractModalMenu from './modules/ContractModalMenu'
