  ...
  export default {
    ...
    data() {
      return {
        ...
        dbUrlMap: {
          // MySQL 数据库
          '1': { dbUrl: 'jdbc:mysql://192.168.101.52:3306/jeecg-boot?characterEncoding=UTF-8&useUnicode=true&useSSL=false' },
          // Oracle
          '2': { dbUrl: 'jdbc:oracle:thin:@192.168.101.52:1521:ORCL' },
          // SQLServer 数据库
          '3': { dbUrl: 'jdbc:sqlserver://192.168.101.52:1433;SelectMethod=cursor;DatabaseName=jeecgboot' }
        }
      }
    },
    created() {
