...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		 System.out.println(PasswordUtil.encrypt("jeecg", "123456", "go3jJ4zX"));
		// System.out.println(PasswordUtil.decrypt("zhagnxiao", "f898134e5e52ae11a2ffb2c3b57a4e90", "go3jJ4zX"));
	}
