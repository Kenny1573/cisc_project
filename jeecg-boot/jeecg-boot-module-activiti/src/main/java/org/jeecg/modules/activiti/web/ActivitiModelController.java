...
public class ActivitiModelController {
    ...
    public void newModel(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
       try {
           ...
           System.out.println("==="+request.getContextPath() + "/activiti/modeler.html?modelId=" + id);
    ...
    public @ResponseBody Result deploy(@PathVariable("id")String id) {
        ...
        try {
            ...
            String encode = Base64.getEncoder().encodeToString(bpmnBytes);
            ...
            System.out.println("+++"+ metaInfoMap);
            // 设置流程分类 保存扩展流程至数据库
