...
public class ActivitiProcessController {
    ...
    public Result listData( HttpServletRequest request){
       ...
       // if (StrUtil.isNotBlank(request.getParameter("roles"))){ //过滤角色
            ...
            //List<String> roleByUserName = new ArrayList<String>();
            //roleByUserName.add("zxb");
    ...
    public Result<Object> delByIds(@RequestBody JSONObject jsonObj){
    ...
    public Result convertToModel( @RequestBody JSONObject jsonObj){
    ...
    public Result getProcessNode(@RequestBody JSONObject jsonObj){
    	String id = jsonObj.getString("id");
    ...
    public Result editNodeUser(@RequestBody JSONObject jsonObj){

    	String nodeId = jsonObj.getString("nodeId");
    	String roleIds = jsonObj.getString("roleIds");
    	String userIds = jsonObj.getString("userIds");
    	String departmentIds = jsonObj.getString("departmentIds");
    	Boolean chooseDep = jsonObj.getBoolean("chooseDep");
    	Boolean chooseDepHeader = jsonObj.getBoolean("chooseDepHeader");
    	Boolean chooseSponsor = jsonObj.getBoolean("chooseSponsor");
        // 删除其关联权限
