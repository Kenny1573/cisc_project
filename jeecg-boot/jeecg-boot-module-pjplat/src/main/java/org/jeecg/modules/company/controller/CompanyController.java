...
public class CompanyController extends JeecgController<Company, ICompanyService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "单位信息-分页列表查询")
	@ApiOperation(value="单位信息-分页列表查询", notes="单位信息-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "单位信息-通过id查询")
	@ApiOperation(value="单位信息-通过id查询", notes="单位信息-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Company company) {
        return super.exportXls(request, company, Company.class, "单位信息");
    }
