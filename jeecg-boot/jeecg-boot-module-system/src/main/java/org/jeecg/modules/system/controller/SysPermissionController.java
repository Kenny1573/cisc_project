...
public class SysPermissionController {
	...
	public Result<?> getBaseInfo(@RequestParam("baseInfo") String baseInfo,@RequestParam("userId") String roleId){

		return Result.ok(sysPermissionService.getProjectListPermission(baseInfo,roleId));
	}
	/**
	 * 加载数据节点
	 * 
