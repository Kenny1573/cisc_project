...
public interface SysDepartMapper extends BaseMapper<SysDepart> {
	...
	//根据depId获取带部门下所有人员的username,realname
	@Select(value = "select USERNAME,REALNAME from SYS_USER where ID in (select USER_ID from SYS_USER_DEPART where DEP_ID=#{depId})")
