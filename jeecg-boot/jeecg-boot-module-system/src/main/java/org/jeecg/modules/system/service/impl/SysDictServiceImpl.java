...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	@Override
	public List<DictModel> queryTableDict(String table, String text, String code, String keyword,String filterSql) {
		return baseMapper.queryTableDict(table, text, code, "%"+keyword+"%",filterSql);
	}
