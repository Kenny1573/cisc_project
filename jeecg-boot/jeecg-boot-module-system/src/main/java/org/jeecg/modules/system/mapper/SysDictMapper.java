...
public interface SysDictMapper extends BaseMapper<SysDict> {
	...
	@Deprecated
	public List<DictModel> queryTableDict(@Param("table") String table,@Param("text") String text,@Param("code") String code,@Param("keyword") String keyword,@Param("filterSql")String filterSql);
