...
var radius = 600; // Độ rộng vòng xoay
var radiusX = -15; // Độ rộng vòng xoay
...
function init(delayTime) {
  for (var i = 0; i < aEle.length; i++) {
    aEle[i].style.transform = "rotateY(" + (i * (360 / aEle.length)) + "deg) rotateX(" + radiusX + "deg) translateZ(" + radius + "px)";
